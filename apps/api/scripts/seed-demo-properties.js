...
function buildProperty(index, office) {
  ...
  return {
    ...
    hasParking: index % 3 !== 1,
    hasSafeRoom: index % 4 !== 0,
    isFurnished: dealType === 'rent' && index % 3 === 0,
    hasStorage: index % 5 === 0,
    hasBalcony: index % 2 === 0,
    isExclusive: index % 4 === 1,
    hasAirCon: true,
    hasBars: index % 6 === 0,
    hasElevator: floor >= 3,
    isAccessible: floor <= 2 || floor % 7 === 0,
    status: 'active',
